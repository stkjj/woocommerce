...
return array(
	...
	'ET' => array( // Ethiopian Regions.
		'AA' => __( 'Addis Ababa \(City\)', 'woocommerce' ),
		'AF' => __( 'Afar Region', 'woocommerce' ),
		'AM' => __( 'Amhara Region', 'woocommerce' ),
		'BG' => __( 'Benishangul-Gumuz Region', 'woocommerce' ),
		'DD' => __( 'Dire Dawa \(City\)', 'woocommerce' ),
		'GA' => __( 'Gambela Region', 'woocommerce' ),
		'HA' => __( 'Harari Region', 'woocommerce' ),
		'OR' => __( 'Oromia Region', 'woocommerce' ),
		'SI' => __( 'Sidama Region', 'woocommerce' ),
		'SO' => __( 'Somali Region', 'woocommerce' ),
		'SN' => __( 'Southern Nations, Nationalities and Peoples\' Region', 'woocommerce' ),
	...
	'RW' => array( // Rwandese Provinces
		'KI' => __( 'Kigali \(City\)', 'woocommerce' ),
		'NO' => __( 'Northern Region', 'woocommerce' ),
		'EA' => __( 'Eastern Region', 'woocommerce' ),
		'SO' => __( 'Southern Region', 'woocommerce' ),
		'WE' => __( 'Western Region', 'woocommerce' ),	
	),
	'RS' => array(),
	'SG' => array(),
	'SK' => array(),
